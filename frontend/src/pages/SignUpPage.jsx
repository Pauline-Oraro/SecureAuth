...
const SignUpPage = () => {
    //a state to keep track of input values
    ...
    <motion.div 
            ...
            >
                ...
                <div className="p-8">
                    ...
                    <motion.button className='mt-5 w-full py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold rounded-lg shadow-lg hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2
